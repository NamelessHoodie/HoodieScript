...
public:
	 ...
	 */
	void addHook(std::unique_ptr<jump_hook> hook);
	 ...
	 */
	jump_hook* accessHook(const std::string& name);
...
private:
	std::vector<std::unique_ptr<jump_hook>> hooks;
